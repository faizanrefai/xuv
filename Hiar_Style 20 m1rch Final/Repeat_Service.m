...
-(void)viewWillAppear:(BOOL)animated{
    ...
    CGRect nameLabelRect2 = CGRectMake(210,10,300,15);
...
//        
    ...
    else 
    {
        ...
        [btnimage4 setImage:[self resizeImage:imageView.image width:btnimage4.frame.size.width height:btnimage4.frame.size.height] forState:UIControlStateNormal];
        [btnimage4 setTitle:@"" forState:UIControlStateNormal];
        
        
        if(Camera)
        {
            btnimage4.transform=CGAffineTransformMakeRotation(M_PI / 2);
